    ...
    public class PawFundContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Donation>().HasData(
                new Donation { Id = 1, DonorId = 6, ShelterId = 1, Amount = 100000, Date = new DateTime(2024, 01, 15), Status = true },
                new Donation { Id = 2, DonorId = 6, ShelterId = 1, Amount = 200000, Date = new DateTime(2024, 02, 10), Status = true },
                new Donation { Id = 3, DonorId = 6, ShelterId = 2, Amount = 543333, Date = new DateTime(2024, 03, 25), Status = true },
                new Donation { Id = 4, DonorId = 6, ShelterId = 2, Amount = 632229, Date = new DateTime(2024, 04, 12), Status = true },
                new Donation { Id = 5, DonorId = 6, ShelterId = 3, Amount = 760000, Date = new DateTime(2024, 05, 20), Status = true },
                new Donation { Id = 6, DonorId = 6, ShelterId = 3, Amount = 200000, Date = new DateTime(2024, 06, 10), Status = true },
                new Donation { Id = 7, DonorId = 6, ShelterId = 2, Amount = 543333, Date = new DateTime(2024, 07, 25), Status = true },
                new Donation { Id = 8, DonorId = 6, ShelterId = 2, Amount = 632229, Date = new DateTime(2024, 08, 12), Status = true },
                new Donation { Id = 9, DonorId = 6, ShelterId = 4, Amount = 760000, Date = new DateTime(2024, 09, 20), Status = true },
                new Donation { Id = 10, DonorId = 6, ShelterId = 1, Amount = 200000, Date = new DateTime(2024, 10, 10), Status = true },
                new Donation { Id = 11, DonorId = 6, ShelterId = 4, Amount = 543333, Date = new DateTime(2024, 11, 25), Status = true },
                new Donation { Id = 12, DonorId = 6, ShelterId = 4, Amount = 632229, Date = new DateTime(2024, 01, 12), Status = true },
                new Donation { Id = 13, DonorId = 6, ShelterId = 3, Amount = 760000, Date = new DateTime(2024, 02, 20), Status = true },
                new Donation { Id = 14, DonorId = 6, ShelterId = 1, Amount = 200000, Date = new DateTime(2024, 03, 10), Status = true },
                new Donation { Id = 15, DonorId = 6, ShelterId = 2, Amount = 543333, Date = new DateTime(2024, 04, 25), Status = true },
                new Donation { Id = 16, DonorId = 6, ShelterId = 3, Amount = 632229, Date = new DateTime(2024, 05, 12), Status = true },
                new Donation { Id = 17, DonorId = 6, ShelterId = 2, Amount = 760000, Date = new DateTime(2024, 06, 20), Status = true },
                new Donation { Id = 18, DonorId = 6, ShelterId = 4, Amount = 200000, Date = new DateTime(2024, 07, 10), Status = true },
                new Donation { Id = 19, DonorId = 6, ShelterId = 3, Amount = 543333, Date = new DateTime(2024, 08, 25), Status = true },
                new Donation { Id = 20, DonorId = 6, ShelterId = 2, Amount = 632229, Date = new DateTime(2024, 09, 12), Status = true },
                new Donation { Id = 21, DonorId = 6, ShelterId = 1, Amount = 760000, Date = new DateTime(2024, 10, 20), Status = true },
                new Donation { Id = 22, DonorId = 6, ShelterId = 4, Amount = 200000, Date = new DateTime(2024, 11, 10), Status = true },
                new Donation { Id = 23, DonorId = 6, ShelterId = 2, Amount = 543333, Date = new DateTime(2024, 01, 25), Status = true },
                new Donation { Id = 24, DonorId = 6, ShelterId = 1, Amount = 632229, Date = new DateTime(2024, 02, 12), Status = true },
                new Donation { Id = 25, DonorId = 6, ShelterId = 2, Amount = 760000, Date = new DateTime(2024, 03, 20), Status = true }
            );
